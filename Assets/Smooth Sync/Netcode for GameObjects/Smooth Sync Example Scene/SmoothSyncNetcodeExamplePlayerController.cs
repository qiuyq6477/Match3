...
/// <summary>An example player controller that works with or without a rigidbody.</summary>
/// <remarks>
...
/// </remarks>
public class SmoothSyncNetcodeExamplePlayerController : NetworkBehaviour
{
    Rigidbody rb;
    Rigidbody2D rb2D;
    SmoothSyncNetcode smoothSync;
	...
	void Start ()
    {
        ...
        smoothSync = GetComponent<SmoothSyncNetcode>();
    ...
    void Update ()
    {
        ...
        if (!(IsOwner || (NetworkManager.IsServer && this.NetworkObject.IsOwnedByServer))) return;
        ...
        // If you need to change ownership of a SmoothSync object you can enable Smooth Authority Changes on Smooth Sync
    ...
    /// </remarks>
    /// </summary>
    public static bool validateStateOfPlayer(StateNetcode latestReceivedState, StateNetcode latestValidatedState)
    {
    ...
    /// </summary>
    //[ServerRpc]
    //public void ClearBufferServerRpc()
    //{
    //    RpcClearBuffer();
    //}
    ///// <summary>
    ...
    ///// </summary>
    //[ClientRpc]
    //public void ClearBufferClientRpc()
    //{
